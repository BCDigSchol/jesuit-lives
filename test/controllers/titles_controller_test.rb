...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { abbreviation: @title.abbreviation, description: @title.description, label: @title.label, unabridged: @title.unabridged } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { abbreviation: @title.abbreviation, description: @title.description, label: @title.label, unabridged: @title.unabridged } }
