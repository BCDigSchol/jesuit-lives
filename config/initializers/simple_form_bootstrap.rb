...
SimpleForm.setup do |config|
  ...
  # custom vertical input group
  config.wrappers :vertical_input_group_custom, tag: 'div', class: 'form-group-wrapper', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :horizontal_form_custom, tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # custom horizontal input for boolean
  config.wrappers :horizontal_boolean_custom, tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
